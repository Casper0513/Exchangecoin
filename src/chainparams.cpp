...
{
    const char* pszTimestamp = "My first Currency being created by myself this day of 2020";
    const CScript genesisOutputScript = CScript() << ParseHex("01578afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1601934186, 2001366426, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000105e97166abaf5913a626c9139c5b658b1e41bacbe000d83b3eb6f3cfa6"));
        assert(genesis.hashMerkleRoot == uint256S("0x11d6de6100011864612cba4b301a5a205b5e759325a9a4be8bb9974b8201a9ff"));
        ...
        vSeeds.emplace_back("198.53.12.1", "198.53.12.1"); 
        ...
        checkpointData = {
            {
                { 0, uint256S("0x00000105e97166abaf5913a626c9139c5b658b1e41bacbe000d83b3eb6f3cfa6")},
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1601934186, 635057, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000ad259a33bf3be7a1afebecaafefe9b323660924095aac8e32b887b44d15"));
        assert(genesis.hashMerkleRoot == uint256S("0x11d6de6100011864612cba4b301a5a205b5e759325a9a4be8bb9974b8201a9ff"));
        ...
        checkpointData = {
            {
                {0, uint256S("00000ad259a33bf3be7a1afebecaafefe9b323660924095aac8e32b887b44d15")},
            }
        };
